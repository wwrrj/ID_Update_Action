...
psyche_source_patch = os.path.join(source_dir, "psyche.txt")
...
psyche_new_name = f"psyche-Xiaomi12X-{time_str}_IDList.txt"
...
psyche_target_path = os.path.join(source_dir, psyche_new_name)
...
os.rename(psyche_source_patch, psyche_target_path)
